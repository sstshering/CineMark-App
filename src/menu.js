...
async function displayMovieReceipt() {
  try {
    console.log('displaying receipt displayMovieReceipt()jsdkfjisldk')
    ...
    movieName.textContent = window.localStorage.getItem('movieSelected')
    ...
    invoiceContainerConessions.id = 'invoiceContainerConcessions1'
...
function saveReceiptInfo() {
 ...
 // var receiptSeatsInfo = document.getElementById('invoiceContainerSeats')
  var receiptConcessionInfo = document.getElementById('invoiceContainerConcessions1')
